...
var setting = {
	...
	callback: {
		beforeClick: function(treeId, treeNode) {
				demoIframe.attr("src","<%=basePath%>auth/module.do?modulelist&pid="+treeNode.id);
				return true;
		}
	}
};
...
<body>
	...
	<tr>
		...
		<td align=left valign=top><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0    width="100%"   SRC="<%=basePath%>auth/module.do?modulelist&pid=0"></iframe></td>
	</tr>
</table>
 </body>
 </html>   